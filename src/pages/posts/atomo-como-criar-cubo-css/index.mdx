...
<PostContentIframe height="500" scrolling="no" title="Cubo (Finalizado)" src="https://codepen.io/hugobessaa/embed/xxqQMZy?height=500&theme-id=dark&default-tab=result" frameBorder="no" loading="lazy" allowtransparency="true" allowFullScreen></PostContentIframe>
