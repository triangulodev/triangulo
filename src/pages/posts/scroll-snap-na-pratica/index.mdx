...
<PostContentIframe height="600" scrolling="no" title="Scroll Snap na prática (Seções horizontais)" src="https://codepen.io/hugobessaa/embed/QWpVNLm?height=500&theme-id=dark&default-tab=result" frameBorder="no" loading="lazy" allowtransparency="true" allowFullScreen />
...
<PostContentIframe height="600" scrolling="no" title="Scroll Snap na prática (Seções horizontais vs)" src="https://codepen.io/hugobessaa/embed/qBrMYPL?height=500&theme-id=dark&default-tab=result" frameBorder="no" loading="lazy" allowtransparency="true" allowFullScreen />
...
<PostContentIframe height="720" scrolling="no" title="Scroll Snap na prática (Ícones de Apps)" src="https://codepen.io/hugobessaa/embed/KKWxzdB?height=500&theme-id=dark&default-tab=result" frameBorder="no" loading="lazy" allowtransparency="true" allowFullScreen />
...
<PostContentIframe height="600" scrolling="no" title="Scroll Snap na prática (Galeria 2D)" src="https://codepen.io/hugobessaa/embed/GRWXxXz?height=500&theme-id=dark&default-tab=result" frameBorder="no" loading="lazy" allowtransparency="true" allowFullScreen />
...
<PostContentIframe height="600" scrolling="no" title="Scroll Snap na prática (Comparando align)" src="https://codepen.io/hugobessaa/embed/bGqxKxj?height=500&theme-id=dark&default-tab=result" frameBorder="no" loading="lazy" allowtransparency="true" allowFullScreen />
